...
export default function Home() {
  return (
    <div className="flex-1 flex flex-col items-center px-6 pt-[8vh] pb-10 text-center">
      <div className="relative w-[280px] h-[280px] orb-rise">
        ...
        />
        <div className="relative w-full h-full rounded-full gradient-bg flex items-center justify-center shadow-[0_30px_80px_rgba(123,122,232,0.4)]">
          <span
            className="text-[88px] leading-none drop-shadow-sm"
            role="img"
            aria-label="sparkles"
          >
            ✨
      ...
      >
        <h1 className="text-[30px] font-bold leading-tight text-text-main mb-3">
          2026 <span className="gradient-text">프리랜서의 날</span>
        </h1>
        <p className="text-[16px] leading-relaxed text-text-sub mb-4">
          남들 쉴 때 세상을 움직이는
          <br />
          당신에게 필요한 건?
        </p>
      ...
      >
        <p className="text-[12px] text-text-sub mb-3">약 1분 소요 · 15문항</p>
        <Link
          href="/test"
